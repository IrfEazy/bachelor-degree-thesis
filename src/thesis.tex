...
% TABLE OF CONTENTS
    ...
    \input{chapters/0_introduzione}


    \chapter{Struttura del programma}
    \label{ch:struttura_del_programma}%
    \input{chapters/1_struttura_del_programma}


    \chapter{Tipi di dati di base}
    \label{ch:tipi_di_dati_di_base}%
    \input{chapters/2_tipi_dati_base}


    \chapter{Tipi compositi}
    \label{ch:tipi_compositi}%
    \input{chapters/3_tipi_compositi}


    \chapter{Funzioni}
    \label{ch:funzioni}%
    \input{chapters/4_funzioni}


    \chapter{Metodi}
    \label{ch:metodi}%
    \input{chapters/5_metodi}


    \chapter{Interfacce}
    \label{ch:interfacce}%
    \input{chapters/6_interfacce}


    \chapter{Goroutine e channel}
    \label{ch:goroutine_e_channel}%
    \input{chapters/7_goroutines_e_channel}


    \chapter{Concorrenza con variabili condivise}
    \label{ch:concorrenza_con_variabili_condivise}%
    \input{chapters/8_concorrenza_con_variabili_condivise}


    \chapter{Conclusioni}
    \label{ch:conclusioni}%
    \input{chapters/9_conclusioni}
